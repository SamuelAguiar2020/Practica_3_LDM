...
public class LoadingScreen extends Pantalla{
    ...
    public void update(float deltaTime) {
        ...
        Assets.barcoarriba = g.newPixmap("pez_arb.png", PixmapFormat.ARGB4444);
        Assets.barcoizquierda = g.newPixmap("pez_izq.png", PixmapFormat.ARGB4444);
        Assets.barcoabajo = g.newPixmap("pez_abj.png", PixmapFormat.ARGB4444);
        Assets.barcoderecha = g.newPixmap("pez_der.png", PixmapFormat.ARGB4444);
        Assets.tripulacion = g.newPixmap("huevas-de-pez.png", PixmapFormat.ARGB4444);
        Assets.botin1 = g.newPixmap("estrella-de-mar.png", PixmapFormat.ARGB4444);
        Assets.botin2 = g.newPixmap("algas-marinas.png", PixmapFormat.ARGB4444);
        Assets.botin3 = g.newPixmap("gamba.png", PixmapFormat.ARGB4444);
